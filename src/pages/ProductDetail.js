...
export const ProductDetail = () => {
  ...
  return (
    <main>
        <section>
          <h1 className="mt-10 mb-5 text-4xl text-center font-bold text-gray-900 dark:text-slate-200">{productData.name}</h1>
          <p className="mb-5 text-lg text-center text-gray-900 dark:text-slate-200">{productData.overview}</p>
          <div className="flex flex-wrap justify-around">
            <div className="max-w-xl my-3">
              <img className="rounded" src={productData.poster} alt={productData.name} />
            </div>
            <div className="max-w-xl my-3">
              ...
              <p className="my-4 select-none">
                {productData.best_seller && <span className="font-semibold text-amber-500 border bg-amber-50 rounded-lg px-3 py-1 mr-2">BEST SELLER</span>}
                { 
                ...
                <span className="font-semibold text-blue-500 border bg-slate-100 rounded-lg px-3 py-1 mr-2">{productData.size} MB</span>
              </p>
              <p className="my-3">
